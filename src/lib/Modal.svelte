...
<script>
     ...
     * @type {(node: Element, parameters: import('svelte/transition').BlurParams) => import("svelte/transition").TransitionConfig}
     */
    export let transitionBg = fade;

    /**
     * Parameters for the background element transition
     * @type {import("svelte/transition").BlurParams}
     */
    ...
    >
        ...
        >
            <div
                ...
                role="dialog"
                aria-modal="true"
                aria-label={state.ariaLabelledBy
                    ? null
                    : state.ariaLabel || null}
